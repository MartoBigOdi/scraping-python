...
class MercadoLibreCrawler(CrawlSpider):
    ...
    start_urls = ['https://vehiculos.mercadolibre.com.ar/']
...
# EJECUCION
# scrapy runspider nivel2_mercadolibre.py -o mercado_libre.json:json
# scrapy runspider nivel2_mercadolibre.py -o mercado_libre.csv:csv