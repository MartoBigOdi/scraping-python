...
login_data = {
  "login": "Marto", # Tu usuario de GITHUB
  # busca el archivo en la raiz del proyecto y coloca tu pass real, desde ese txt obtenemos el pass
...
print("Json POST: " + colored(login_data, 'yellow', 'on_black', ['bold', 'blink']))
...
data_url = 'https://github.com/MartoBigOdi?tab=repositories'
...
print(colored("GitHub Repositories User:", 'green', 'on_black', ['bold', 'blink']))
for repositorio in repositorios:
  print (colored(repositorio, 'green'))